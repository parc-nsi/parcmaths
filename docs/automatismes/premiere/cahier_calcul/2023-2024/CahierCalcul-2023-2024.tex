...
\fancyhead[C]{\textbf{Cahier de calcul}}
...
{\itshape Exercices générés pour la plupart avec le site \url{https://coopmaths.fr/alea/}.
} 
...
\begin{enumerate}[itemsep=2em]
	\item $\dfrac{9}{5}+\dfrac{6}{2}=$
	\item $\dfrac{8}{3}+4=$
	\item $\dfrac{9}{4}+\dfrac{4}{8}=$
	\item $\dfrac{8}{6}+\dfrac{5}{21}=$
	\item $\dfrac{5}{12}+\dfrac{6}{8}=$
	\item $\dfrac{9}{2}+\dfrac{1}{9}=$
	\item $\dfrac{5}{4}+\dfrac{9}{16}=$
\end{enumerate}
\end{multicols}
\end{exerciceB2}
...
\begin{enumerate}[itemsep=3em]
	\item $\dfrac{35}{12}\times\dfrac{8}{63}=$
	\item $\dfrac{7}{-10}\times\dfrac{2}{-49}=$
	\item $\dfrac{33}{35}\times\dfrac{5}{44}=$
	\item $\dfrac{-35}{45}\times\dfrac{-15}{-49}=$
	\item $\dfrac{10}{63}\times\dfrac{7}{25}=$
\end{enumerate}
\end{multicols}
\end{exerciceB2}


\section{Calcul avec des puissances}
...
\begin{enumerate}[itemsep=1em]
	\item Écrire $6^{3}$ avec des $\times$ et sans utiliser la notation puissance.
	\item Simplifier $- \dfrac{1}{(-3)\times(-3)\times(-3)\times(-3)\times(-3)\times(-3)\times(-3)\times(-3)}$ en utilisant la notation puissance.
	\item Écrire $-4^{-2}$ avec des $\times$ et sans utiliser la notation puissance.
	\item Simplifier $ (-2)\times(-2)$ en utilisant la notation puissance.
\end{enumerate}
\end{exerciceB2}
...
Supprimer les parenthèses (niveau 1).
...
Supprimer les parenthèses et réduire (niveau 2).

\begin{multicols}{2}

\begin{enumerate}[itemsep=2em,label={}]
	\item $A= -(7z^2-5z-9) + (-8z^2-5z-2)$
	\item $B= (a^2+3a+10) - (-11a^2-2a-10)$
	\item $C= -(-9x+9) + (3x+1)$
	\item $D= (-7a-9) - (4a^2-10a+1)$
	\item $E= -(-2c-5) + (11c^2-10c+8)$
	\item $F= (9a+9) - (4a+11)$
\end{enumerate}
\end{multicols}
\end{exerciceB2}
...
\begin{enumerate}[itemsep=1em,label={}]
	\item \begin{minipage}[t]{\linewidth}$A=5x^2+x$\end{minipage}
	\item \begin{minipage}[t]{\linewidth}$B=4x^2+7x$\end{minipage}
	\item \begin{minipage}[t]{\linewidth}$C=-49a+56b$\end{minipage}
	\item \begin{minipage}[t]{\linewidth}$D=5a-15b$\end{minipage}
	\item \begin{minipage}[t]{\linewidth}$E=9a-15b$\end{minipage}
	\item \begin{minipage}[t]{\linewidth}$F=-7a-21b$\end{minipage}
	\item \begin{minipage}[t]{\linewidth}$G=-44x-99x^2$\end{minipage}
	\item \begin{minipage}[t]{\linewidth}$H=-56x+63x^2$\end{minipage}
\end{enumerate}
\end{multicols}
  ...
  \begin{enumerate}
    \item $A=x^{2}-10x+25$
     \item $B=9x^2-6x+1$
        ...
        \item $D=x^{2}-16$
   \item $E=(x+1)^2-(3-2x)^2$ ;
    \item $F=x^{2}-2x+1+(1-x)(2x+1)$ ;
    \item $G=(x+1)(2x+3)+x^2-1$.
  \end{enumerate}
\end{multicols}
\end{exerciceB2}
...
\begin{enumerate}[itemsep=1em]
	\item Préciser les valeurs interdites éventuelles, puis écrire l'expression sous la forme d'un quotient (réduire le numérateur) : $2x-3+\dfrac{1}{2x+2}$.
	\item Préciser les valeurs interdites éventuelles, puis écrire l'expression sous la forme d'un quotient (réduire le numérateur) : $\dfrac{6}{4x+15}-\dfrac{16}{5x+15}$.
	\item Préciser les valeurs interdites éventuelles, puis écrire l'expression sous la forme d'un quotient : $9+\dfrac{7}{x}$.
	\item Préciser les valeurs interdites éventuelles, puis écrire l'expression sous la forme d'un quotient (réduire le numérateur) : $\dfrac{3}{x}+\dfrac{1}{4x-1}$.
	\item Préciser les valeurs interdites éventuelles, puis écrire l'expression sous la forme d'un quotient (réduire le numérateur) : $-5-\dfrac{13}{4x+12}$.
	\item Préciser les valeurs interdites éventuelles, puis écrire l'expression sous la forme d'un quotient (réduire le numérateur) : $4x+\dfrac{1}{x+2}$.
	\item Préciser les valeurs interdites éventuelles, puis écrire l'expression sous la forme d'un quotient : $-x+\dfrac{6}{x}$.
\end{enumerate}

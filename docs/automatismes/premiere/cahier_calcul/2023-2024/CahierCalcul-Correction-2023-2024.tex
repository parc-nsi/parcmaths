...
\usetikzlibrary{arrows, arrows.meta, positioning, snakes, calc, shapes.misc, decorations.shapes, shapes.geometric, graphs, decorations.markings, backgrounds, shapes}
\usetikzlibrary{math}
...
\newcounter{thema}
\newenvironment{theme}[1]
{\par \medskip   \addtocounter{thema}{1} \noindent  
 \begin {bclogo}[couleur = blue!10 , arrondi =0.1,logo=\bcoeil, marge=4] {~\textbf{Thème} \textbf{\thethema} {\itshape #1} }  \par}
{
\end{bclogo}
 \par \bigskip }
...
%%%%%%Fichier de style APMEP Olympiades %%%%%%%%%%%%%%%%%%%%%%%
...
\fancyhead[C]{\textbf{Correction du cahier de calcul 2023-2024}}
\fancyfoot[R]{\url{https://coopmaths.fr/alea}}
\fancyfoot[L]{\url{https://frederic-junier.org/}}
...
{\itshape Corrections générées avec le site \url{https://coopmaths.fr/alea/}.
} 
...
\subsection{Calcul avec des fractions}

\begin{corrige}{}
Additionner des fractions.

\begin{enumerate}[itemsep=2em]
\item $\dfrac{9}{5}+\dfrac{6}{2}=\dfrac{9{\color[HTML]{f15929}\boldsymbol{\times 2}}}{5{\color[HTML]{f15929}\boldsymbol{\times 2}}}+\dfrac{6{\color[HTML]{f15929}\boldsymbol{\times 5}}}{2{\color[HTML]{f15929}\boldsymbol{\times 5}}}=\dfrac{18+30}{10}=\dfrac{48}{10}=\dfrac{24{\color[HTML]{f15929}\boldsymbol{\times2}}}{5{\color[HTML]{f15929}\boldsymbol{\times2}}}=\dfrac{24}{5}$
\item $\dfrac{8}{3}+4=$$\dfrac{8}{3}+\dfrac{4\times 3}{3}=\dfrac{8+12}{3}=\dfrac{20}{3}$
\item $\dfrac{9}{4}+\dfrac{4}{8}=\dfrac{9{\color[HTML]{f15929}\boldsymbol{\times 2}}}{4{\color[HTML]{f15929}\boldsymbol{\times 2}}}+\dfrac{4}{8}=\dfrac{18+4}{8}=\dfrac{22}{8}=\dfrac{11{\color[HTML]{f15929}\boldsymbol{\times2}}}{4{\color[HTML]{f15929}\boldsymbol{\times2}}}=\dfrac{11}{4}$
\item $\dfrac{8}{6}+\dfrac{5}{21}=\dfrac{8{\color[HTML]{f15929}\boldsymbol{\times 7}}}{6{\color[HTML]{f15929}\boldsymbol{\times 7}}}+\dfrac{5{\color[HTML]{f15929}\boldsymbol{\times 2}}}{21{\color[HTML]{f15929}\boldsymbol{\times 2}}}=\dfrac{56+10}{42}=\dfrac{66}{42}=\dfrac{11{\color[HTML]{f15929}\boldsymbol{\times6}}}{7{\color[HTML]{f15929}\boldsymbol{\times6}}}=\dfrac{11}{7}$
\item $\dfrac{5}{12}+\dfrac{6}{8}=\dfrac{5{\color[HTML]{f15929}\boldsymbol{\times 2}}}{12{\color[HTML]{f15929}\boldsymbol{\times 2}}}+\dfrac{6{\color[HTML]{f15929}\boldsymbol{\times 3}}}{8{\color[HTML]{f15929}\boldsymbol{\times 3}}}=\dfrac{10+18}{24}=\dfrac{28}{24}=\dfrac{7{\color[HTML]{f15929}\boldsymbol{\times4}}}{6{\color[HTML]{f15929}\boldsymbol{\times4}}}=\dfrac{7}{6}$
\item $\dfrac{9}{2}+\dfrac{1}{9}=\dfrac{9{\color[HTML]{f15929}\boldsymbol{\times 9}}}{2{\color[HTML]{f15929}\boldsymbol{\times 9}}}+\dfrac{1{\color[HTML]{f15929}\boldsymbol{\times 2}}}{9{\color[HTML]{f15929}\boldsymbol{\times 2}}}=\dfrac{81+2}{18}=\dfrac{83}{18}$
\item $\dfrac{5}{4}+\dfrac{9}{16}=\dfrac{5{\color[HTML]{f15929}\boldsymbol{\times 4}}}{4{\color[HTML]{f15929}\boldsymbol{\times 4}}}+\dfrac{9}{16}=\dfrac{20+9}{16}=\dfrac{29}{16}$
\end{enumerate}
\end{corrige}
...
\item $\dfrac{35}{12}\times \dfrac{8}{63}=\dfrac{35\times8}{12\times63}
    =\dfrac{5\times7\times 2\times2\times2}{2\times2\times3\times 3\times3\times7}=\dfrac{\cancel{2}\times\cancel{2}\times2\times5\times\cancel{7}}{\cancel{2}\times\cancel{2}\times3\times3\times3\times\cancel{7}}=\dfrac{10}{27}$
\item $\dfrac{7}{-10}\times \dfrac{2}{-49}=\dfrac{7\times2}{-10\times(-49)}
    =\dfrac{7\times 2}{(-2)\times5\times (-7)\times7}=\dfrac{\cancel{2}\times\cancel{7}}{\cancel{2}\times5\times\cancel{7}\times7}=\dfrac{1}{35}$
\item $\dfrac{33}{35}\times \dfrac{5}{44}=\dfrac{33\times5}{35\times44}
    =\dfrac{3\times11\times 5}{5\times7\times 2\times2\times11}=\dfrac{3\times\cancel{5}\times\cancel{11}}{2\times2\times\cancel{5}\times7\times\cancel{11}}=\dfrac{3}{28}$
\item $\dfrac{-35}{45}\times \dfrac{-15}{-49}=\dfrac{-35\times(-15)}{45\times(-49)}
    =\dfrac{(-5)\times7\times (-3)\times5}{3\times3\times5\times (-7)\times7}=-\dfrac{\cancel{3}\times\cancel{5}\times5\times\cancel{7}}{\cancel{3}\times3\times\cancel{5}\times\cancel{7}\times7}=-\dfrac{5}{21}$
\item $\dfrac{10}{63}\times \dfrac{7}{25}=\dfrac{10\times7}{63\times25}
    =\dfrac{2\times5\times 7}{3\times3\times7\times 5\times5}=\dfrac{2\times\cancel{5}\times\cancel{7}}{3\times3\times\cancel{5}\times5\times\cancel{7}}=\dfrac{2}{45}$
\end{enumerate}
\end{corrige}

\subsection{Calcul avec des puissances}
...
\item $A=\color{red}{\underbrace{\mathbf{\color{red}{((-4)^3)}} \times \mathbf{\color{red}{((-4)^3)}}\times \mathbf{\color{red}{((-4)^3)}}\times \mathbf{\color{red}{((-4)^3)}}}_{4\thickspace\text{facteurs}}}$\\$A=\color{red}{\underbrace{\mathbf{\color{red}{(\color{blue}{\underbrace{\mathbf{\color{blue}{(-4)}} \times \mathbf{\color{blue}{(-4)}}\times \mathbf{\color{blue}{(-4)}}}_{3\thickspace\text{facteurs}}}\color{red})}} \times \mathbf{\color{red}{(\color{blue}{\underbrace{\mathbf{\color{blue}{(-4)}} \times \mathbf{\color{blue}{(-4)}}\times \mathbf{\color{blue}{(-4)}}}_{3\thickspace\text{facteurs}}}\color{red})}}\times \mathbf{\color{red}{(\color{blue}{\underbrace{\mathbf{\color{blue}{(-4)}} \times \mathbf{\color{blue}{(-4)}}\times \mathbf{\color{blue}{(-4)}}}_{3\thickspace\text{facteurs}}}\color{red})}}\times \mathbf{\color{red}{(\color{blue}{\underbrace{\mathbf{\color{blue}{(-4)}} \times \mathbf{\color{blue}{(-4)}}\times \mathbf{\color{blue}{(-4)}}}_{3\thickspace\text{facteurs}}}\color{red})}}}_{4\times\color{blue}{3}\thickspace\color{black}{\text{facteurs}}}}$\\Il y a donc $\mathbf{\color{red}{4}~\color{black}{\times}~\color{blue}{3}}$ facteurs tous égaux à $(-4)$.\\$A=(-4)^{3\times4} = (-4)^{12} = {\color[HTML]{f15929}\boldsymbol{ 4^{12}}}$\\\textbf{Remarque : } Dans ce cas, comme les puissances d'exposant pair de deux nombres opposés sont égales, on peut écrire $ 4^{12}$ à la place de $(-4)^{12}$.
\item $B=\color{red}{\underbrace{\mathbf{\color{red}{(7^4)}} \times \mathbf{\color{red}{(7^4)}}\times \mathbf{\color{red}{(7^4)}}}_{3\thickspace\text{facteurs}}}$\\$B=\color{red}{\underbrace{\mathbf{\color{red}{(\color{blue}{\underbrace{\mathbf{\color{blue}{7}} \times \mathbf{\color{blue}{7}}\times \mathbf{\color{blue}{7}}\times \mathbf{\color{blue}{7}}}_{4\thickspace\text{facteurs}}}\color{red})}} \times \mathbf{\color{red}{(\color{blue}{\underbrace{\mathbf{\color{blue}{7}} \times \mathbf{\color{blue}{7}}\times \mathbf{\color{blue}{7}}\times \mathbf{\color{blue}{7}}}_{4\thickspace\text{facteurs}}}\color{red})}}\times \mathbf{\color{red}{(\color{blue}{\underbrace{\mathbf{\color{blue}{7}} \times \mathbf{\color{blue}{7}}\times \mathbf{\color{blue}{7}}\times \mathbf{\color{blue}{7}}}_{4\thickspace\text{facteurs}}}\color{red})}}}_{3\times\color{blue}{4}\thickspace\color{black}{\text{facteurs}}}}$\\Il y a donc $\mathbf{\color{red}{3}~\color{black}{\times}~\color{blue}{4}}$ facteurs tous égaux à $7$.\\$B=7^{4\times3} = {\color[HTML]{f15929}\boldsymbol{7^{12}}}$
\item $C=\dfrac{\mathbf{\color{red}{8}} \times \mathbf{\color{red}{8}}\times \mathbf{\color{red}{8}}\times \mathbf{\color{red}{8}}}{\mathbf{\color{blue}{8}} \times \mathbf{\color{blue}{8}}}$\\Il y a donc $\mathbf{\color{blue}{2}}$ simplifications par $8$ possibles.\\$C=\dfrac{\mathbf{\color{red}{\cancel{8}}} \times \mathbf{\color{red}{\cancel{8}}}\times\mathbf{\color{red}{8}} \times \mathbf{\color{red}{8}}}{\mathbf{\color{blue}{\cancel{8}}} \times \mathbf{\color{blue}{\cancel{8}}}}$\\$C=8^{4-2}={\color[HTML]{f15929}\boldsymbol{8^{2}}}$
\item $D=\mathbf{\color{red}{9}} \times \mathbf{\color{red}{9}}\times \mathbf{\color{red}{9}}\times \mathbf{\color{red}{9}} \times \mathbf{\color{blue}{9}} \times \mathbf{\color{blue}{9}}\times \mathbf{\color{blue}{9}}$\\Il y a donc $\mathbf{\color{red}{4}~\color{black}{+}~\color{blue}{3}}$ facteurs tous égaux à $9$.\\$D=9^{4+3} = {\color[HTML]{f15929}\boldsymbol{9^{7}}}$
\item $E=8^5\times 2^5$\\$E=\mathbf{\color{red}{8}} \times \mathbf{\color{red}{8}}\times \mathbf{\color{red}{8}}\times \mathbf{\color{red}{8}}\times \mathbf{\color{red}{8}} \times \mathbf{\color{blue}{2}} \times \mathbf{\color{blue}{2}}\times \mathbf{\color{blue}{2}}\times \mathbf{\color{blue}{2}}\times \mathbf{\color{blue}{2}}$\\$E=\mathbf{(\color{red}{8}} \times \mathbf{\color{blue}{2}}) \times (\mathbf{\color{red}{8}} \times \mathbf{\color{blue}{2}})\times (\mathbf{\color{red}{8}} \times \mathbf{\color{blue}{2}})\times (\mathbf{\color{red}{8}} \times \mathbf{\color{blue}{2}})\times (\mathbf{\color{red}{8}} \times \mathbf{\color{blue}{2}})$\\$E= (\color{red}{\mathbf{8}} \color{black}{\times} \color{blue}{\mathbf{2}}\color{black}{)^{5}}={\color[HTML]{f15929}\boldsymbol{16^5}}$
\item $F=\mathbf{\color{red}{5}} \times \mathbf{\color{red}{5}}\times \mathbf{\color{red}{5}}\times \mathbf{\color{red}{5}} \times \mathbf{\color{blue}{5}} \times \mathbf{\color{blue}{5}}\times \mathbf{\color{blue}{5}}\times \mathbf{\color{blue}{5}}\times \mathbf{\color{blue}{5}}$\\Il y a donc $\mathbf{\color{red}{4}~\color{black}{+}~\color{blue}{5}}$ facteurs tous égaux à $5$.\\$F=5^{4+5} = {\color[HTML]{f15929}\boldsymbol{5^{9}}}$
\item $G=3^3\times 5^3$\\$G=\mathbf{\color{red}{3}} \times \mathbf{\color{red}{3}}\times \mathbf{\color{red}{3}} \times \mathbf{\color{blue}{5}} \times \mathbf{\color{blue}{5}}\times \mathbf{\color{blue}{5}}$\\$G=\mathbf{(\color{red}{3}} \times \mathbf{\color{blue}{5}}) \times (\mathbf{\color{red}{3}} \times \mathbf{\color{blue}{5}})\times (\mathbf{\color{red}{3}} \times \mathbf{\color{blue}{5}})$\\$G= (\color{red}{\mathbf{3}} \color{black}{\times} \color{blue}{\mathbf{5}}\color{black}{)^{3}}={\color[HTML]{f15929}\boldsymbol{15^3}}$
\end{enumerate}
\end{corrige}
...
\begin{enumerate}[itemsep=1em]
\item $6^{3} = 6\times6\times6$
\item $- \dfrac{1}{(-3)\times(-3)\times(-3)\times(-3)\times(-3)\times(-3)\times(-3)\times(-3)} = -(-3)^{-8}$
\item $-4^{-2} = -\dfrac{1}{4\times4}$
\item $ (-2)\times(-2) = (-2)^{2}$
\end{enumerate}
\end{corrige}
...
\subsection{Supprimer des parenthèses et réduire}

\begin{corrige}{}

Supprimer des parenthèses (niveau 1).

\begin{enumerate}[itemsep=1em]
\item $A=(-2y+4)$\\$A=$ ${\color[HTML]{f15929}\boldsymbol{-2y+4}}$
\item $B=-(-2a^2-7a-11)$\\$B=$ ${\color[HTML]{f15929}\boldsymbol{2a^2+7a+11}}$
\item $C=(6a^2+4a+1)$\\$C=$ ${\color[HTML]{f15929}\boldsymbol{6a^2+4a+1}}$
\item $D=-(5x^2-7x+7)$\\$D=$ ${\color[HTML]{f15929}\boldsymbol{-5x^2+7x-7}}$
\item $E=(-y+4)$\\$E=$ ${\color[HTML]{f15929}\boldsymbol{-y+4}}$
\item $F=-(-8a+5)$\\$F=$ ${\color[HTML]{f15929}\boldsymbol{8a-5}}$
\end{enumerate}
...
Supprimer les parenthèses (niveau 2).


\begin{enumerate}[itemsep=1em]
\item $A= -(7z^2-5z-9) + (-8z^2-5z-2)$\\$A= -7z^2+5z+9  -8z^2-5z-2$\\$A=$ ${\color[HTML]{f15929}\boldsymbol{-15z^2+7}}$
\item $B= (a^2+3a+10) - (-11a^2-2a-10)$\\$B= a^2+3a+10 + 11a^2+2a+10$\\$B=$ ${\color[HTML]{f15929}\boldsymbol{12a^2+5a+20}}$
\item $C= -(-9x+9) + (3x+1)$\\$C= 9x-9 + 3x+1$\\$C=$ ${\color[HTML]{f15929}\boldsymbol{12x-8}}$
\item $D= (-7a-9) - (4a^2-10a+1)$\\$D= -7a-9  -4a^2+10a-1$\\$D=$ ${\color[HTML]{f15929}\boldsymbol{-4a^2+3a-10}}$
\item $E= -(-2c-5) + (11c^2-10c+8)$\\$E= 2c+5 + 11c^2-10c+8$\\$E=$ ${\color[HTML]{f15929}\boldsymbol{11c^2-8c+13}}$
\item $F= (9a+9) - (4a+11)$\\$F= 9a+9  -4a-11$\\$F=$ ${\color[HTML]{f15929}\boldsymbol{5a-2}}$
\end{enumerate}
...
\begin{enumerate}[itemsep=2em]
\item $A=-10y(7y-9)$\\
          $A=-10y\times 7y + (-10y)\times (-9)$\\Et si on réduit l'expression, on obtient : \\ $A=-70y^2+90y$.
\item $B=-2(-7b+6)$\\
          $B=-2\times (-7b)+(-2)\times6$\\Et si on réduit l'expression, on obtient : \\ $B=14b-12$.
\item $C=(-4a-3)\times(-7)$\\
          $C=-7\times (-4a)+(-7)\times(-3)$\\Et si on réduit l'expression, on obtient : \\ $C=28a+21$.
\item $D=(7t+8)\times5t$\\
          $D=5t\times 7t+5t\times8$\\Et si on réduit l'expression, on obtient : \\ $D=35t^2+40t$.
\item $E=-2+9(8x+6)$\\
          $E=-2+9\times8x+9\times6$\\Et si on réduit l'expression, on obtient : \\ $E=-2+72x+54=72x+52$.
\item $F=-7(-4y+9)-8$\\
          $F=-7\times(-4y)+(-7)\times9-8$\\Et si on réduit l'expression, on obtient : \\ $F=28y-63-8=28y-71$.
\end{enumerate}
\end{corrige}
...
\begin{enumerate}[itemsep=1em]
\item $A =  (3x+8)(9x+9)$ \\$A = 27x^2+27x+72x+72$ \\$A =$ ${\color[HTML]{f15929}\boldsymbol{ 27x^2+99x+72 }}$
\item $B =  (x+9)(x+4)$ \\$B = x^2+9x+4x+36$ \\$B =$ ${\color[HTML]{f15929}\boldsymbol{ x^2+13x+36 }}$
\item $C =  (x+4)(x+4)$ \\$C = x^2+4x+4x+16$ \\$C =$ ${\color[HTML]{f15929}\boldsymbol{ x^2+8x+16 }}$
\item $D =  (3x+9)(5x+6)$ \\$D = 15x^2+18x+45x+54$ \\$D =$ ${\color[HTML]{f15929}\boldsymbol{ 15x^2+63x+54 }}$
\item $E =  (x+6)(x+3)$ \\$E = x^2+6x+3x+18$ \\$E =$ ${\color[HTML]{f15929}\boldsymbol{ x^2+9x+18 }}$
\item $F= 5x(x-1)(7x-2) = 5x(7x^{2}-2x-7x+2)=$ ${\color[HTML]{f15929}\boldsymbol{35x^{3}-45x^{2}+10x}}$.
\end{enumerate}
\end{corrige}
...
\begin{enumerate}[itemsep=2em]
\item $(x-3)(x+3)=x^2-3^2=x^2-9$
\item $(8x+4)^2=(8x)^2+2 \times 8x \times 4 + 4^2=64x^2+64x+16$
\item $(x-3)^2=x^2-2 \times 3 \times x+3^2=x^2-6x+9$
\item $(3x+8)^2=(3x)^2+2 \times 3x \times 8 + 8^2=9x^2+48x+64$
\item $(4x-7)(4x+7)=(4x)^2-7^2=16x^2-49$
\end{enumerate}
...
\begin{enumerate}[itemsep=1em]
\item $A=5x^2+x$\\$\phantom{A}=x\times 5x+x\times 1$\\$\phantom{A}=x(5x+1)$
\item $B=4x^2+7x$\\$\phantom{B}=x\times 4x+x\times 7$\\$\phantom{B}=x(4x+7)$
\item $C=-49a+56b$\\$\phantom{C}=7\times(-7a)+7\times8b$\\$\phantom{C}=7(-7a+8b)$
\item $D=5a-15b$\\$\phantom{D}=5a-5\times3b$\\$\phantom{D}=5(a-3b)$
\item $E=9a-15b$\\$\phantom{E}=3\times3a-3\times5b$\\$\phantom{E}=3(3a-5b)$
\item $F=-7a-21b$\\$\phantom{F}=-7a+(-7)\times3b$\\$\phantom{F}=-7(a+3b)$
\item $G=-44x-99x^2$\\$\phantom{G}=11x\times(-4)-11x\times9x$\\$\phantom{G}=11x(-4-9x)$
\item $H=-56x+63x^2$\\$\phantom{H}=7x\times(-8)+7x\times9x$\\$\phantom{H}=7x(-8+9x)$
\end{enumerate}
\end{corrige}
...
\begin{enumerate}[itemsep=1em]
\item $A =  16x^2-25$ \\$A = (4x)^2-5^2$ \\$A = (4x-5)(4x+5)$ \\
\item $B =  x^2-36$ \\$B = x^2-6^2$ \\$B = (x-6)(x+6)$ \\
\item $C =  \dfrac{81}{100}x^2-25$ \\$C = \left(\dfrac{9}{10}x\right)^2-5^2$ \\$C = \left(\dfrac{9}{10}x-5\right)\left(\dfrac{9}{10}x+5\right)$ \\
\item $D =  16x^2-81$ \\$D = (4x)^2-9^2$ \\$D = (4x-9)(4x+9)$ \\
\item On reconnaît l'identité remarquable $a^2-b^2=(\color{red}a\color{black}-\color{blue}b)(\color{red}a\color{black}+\color{blue}b)$, avec $a=\color{red}2x+8$ et $b=\color{blue}6$.

\medskip

                    $(2x+8)^2-36= (\color{red} 2x+8\color{black})^2-\color{blue}6\color{black}^2 $ \\
                    $\phantom{(2x+8)^2-36}=\left[\color{red} (2x+8)\color{black}-\color{blue} 6\right] \left[ \color{red}(2x+8)\color{black}+\color{blue}6\right] $\\
                    $\phantom{(2x+8)^2-36}= (2x+2) (2x+14)$
\item On reconnaît l'identité remarquable $a^2-b^2=(\color{red}a\color{black}-\color{blue}b)(\color{red}a\color{black}+\color{blue}b)$, avec $a=\color{red}8x+4$ et $b=\color{blue}9$.

\medskip

                    $(8x+4)^2-81= (\color{red} 8x+4\color{black})^2-\color{blue}9\color{black}^2 $ \\
                    $\phantom{(8x+4)^2-81}=\left[\color{red} (8x+4)\color{black}-\color{blue} 9\right] \left[ \color{red}(8x+4)\color{black}+\color{blue}9\right] $\\
                    $\phantom{(8x+4)^2-81}= (8x-5) (8x+13)$
\item On reconnaît l'identité remarquable $a^2-b^2=(\color{red}a\color{black}-\color{blue}b)(\color{red}a\color{black}+\color{blue}b)$, avec $a=\color{red}8x-3$ et $b=\color{blue}7$.

\medskip

                    $(8x-3)^2-49= (\color{red} 8x-3\color{black})^2-\color{blue}7\color{black}^2 $ \\
                    $\phantom{(8x-3)^2-49}=\left[\color{red} (8x-3)\color{black}-\color{blue} 7\right] \left[ \color{red}(8x-3)\color{black}+\color{blue}7\right] $\\
                    $\phantom{(8x-3)^2-49}= (8x-10) (8x+4)$
...
Factoriser avec une identité remarquable.
  ...
  \begin{enumerate}
    \item $A=x^{2}-10x+25=(x-5)^{2}$
     \item $B=9x^2-6x+1=(3x)^{2}- 2 \times 3 \times x + 1^{2}=(3x-1)^{2}$
        \item $C=4x^2+12x+9=(2x)^{2}+2 \times 3 \times 2x x + 3^{2}=(2x+3)^{2}$
                \item $D=x^{2}-16=(x-4)(x+4)$
   \item $E=(x+1)^2-(3-2x)^2 = (x+1+3-2x)(x+1-(3-2x))=(4-x)(3x-2)$ ;
    \item $F=x^{2}-2x+1+(1-x)(2x+1)=(x-1)^{2}-(x-1)(2x+1)=(x-1)(x-1-(2x+1))=(x-1)(-x-2)$ ;
    \item $G=(x+1)(2x+3)+x^2-1=(x+1)(2x+3)+(x-1)(x+1)=(x+1)(2x+3+x-1)=(x+1)(3x+2)$.
  \end{enumerate}
...
\subsection{Mettre au même dénominateur des expression littérales}
...
\item Déterminer les valeurs interdites de cette expression, revient à
            ...
            $\begin{aligned}
            4x+\dfrac{1}{x+2}&=\dfrac{4x(x+2)}{x+2}+\dfrac{1}{x+2}\\
            &=\dfrac{4x^2+8x+1}{x+2}\\
            &=\dfrac{4x^2+8x+1}{x+2}
            \end{aligned}$
\item Déterminer les valeurs interdites de cette expression, revient à déterminer les valeurs qui annulent le dénominateur de $\dfrac{6}{x}$, puisque la division par $0$ n'existe pas.\\
          $0$ est donc une valeur interdite. \\
            Pour $x\in \mathbb{R}^*$,\\
            $\begin{aligned}
            -x+\dfrac{6}{x}&=\dfrac{-x^2}{x}+\dfrac{6}{x}\\
           &= \dfrac{-x^2+6}{x}
           \end{aligned}$
